...
switch ($categoria) {
    case 'ferramenta':
        $categoriaTitulo = "Ferramentas";
        break;
    case 'eletrodoméstico':
        $categoriaTitulo = "Eletrodomésticos";
        break;
    case 'moda':
        $categoriaTitulo = "Moda";
        break;
    case 'tecnologia':
        $categoriaTitulo = "Tecnologia";
        break;
    case 'acessório':
        $categoriaTitulo = "Acessórios";
        break;
    case 'móvel':
        $categoriaTitulo = "Móveis";
        break;
    case 'esporte':
        $categoriaTitulo = "Esporte";
        break;
        default:
        $categoriaTitulo = "";
        break;
...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder"><?php echo $categoriaTitulo ?></h1>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <?php
            $querySelect = "SELECT * FROM produtos where CATEGORIA = '$categoria'";
