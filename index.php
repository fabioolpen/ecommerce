...
<header>
        ...
        <div class="text-center">
            <img class="img-fluid" width="100%" src="e-Commerce.png">
        </div>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                echo "</div><span class='text-muted text-decoration-line-through'>R$ $valorAntigo</span>
                    ...
                    <div class='card-footer p-4 pt-0 border-top-0 bg-transparent'>
                       <div class='row col text-center'><a class='col btn btn-outline-dark mt-auto' href='carrinho.php?id={$row['ID']}'>Comprar</a></div>
