...
$cep_origem = "88240000";     // Seu CEP , ou CEP da Loja
...
$frete =  $xml->cServico;
$valorFrete = floatval($frete->Valor);

echo "<input class='cart-frete' type='number' value='$valorFrete' name='valorFrete2' id='valorFrete2' style='display: none'> 
<input type='text' value='$frete->PrazoEntrega' name='prazoEntrega' id='prazoEntrega' style='display: none'> 
 <p>FRETE</p><span>Valor PAC: R$ ".$frete->Valor."<br />Prazo: ".$frete->PrazoEntrega." dias</span>";
